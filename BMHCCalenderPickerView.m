...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if (cell.canBeOper) {
        ...
        [BMStatisticsTool addActionLog:@"TripHelperListPG.calendarClick" params:@{@"type":@(1)}];

    }else{
        [[CustomShowMessage getInstance] showNotificationMessage:@"您该日暂无行程"];

        [BMStatisticsTool addActionLog:@"TripHelperListPG.calendarClick" params:@{@"id":@(0)}];
    }
}
