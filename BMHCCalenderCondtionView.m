...
- (void)arrowImageViewDidTap:(UITapGestureRecognizer *)tap
{
    if([tap isKindOfClass:[UISwipeGestureRecognizer class]]){
         [BMStatisticsTool addActionLog:@"TripHelperListPG.calendarOpen" params:@{@"type":@(0)}];
    }
    else{
        [BMStatisticsTool addActionLog:@"TripHelperListPG.calendarOpen" params:@{@"type":@(1)}];
    }
...
{
    if([tap isKindOfClass:[UISwipeGestureRecognizer class]]){
        [BMStatisticsTool addActionLog:@"TripHelperListPG.calendarClose" params:@{@"type":@(0)}];
    }
    else{
        [BMStatisticsTool addActionLog:@"TripHelperListPG.calendarClose" params:@{@"type":@(1)}];
    }
